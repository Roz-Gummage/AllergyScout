...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function createModal(id, title, body, footer) {
            ...
            console.log(body);
            var $modalHeaderButton = $('<button type="button" class="close" data-dismiss="modal">&times;</button>'); //aria-hidden="false"
            ...
            var $modalFade = $('<div class="modal fade" id="' + id + '_modal" tabindex="-1" role="dialog"></div>'); //aria-labelledby="' + id + '_modal_title" aria-hidden="false"
